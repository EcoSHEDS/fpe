...
exports.up = async function (knex) {
  ...
  await knex.raw(`
    create or replace function f_station_random_image_pairs(_station_id int, _n_pairs int, _min_hour int, _max_hour int, _min_date date, _max_date date)
      returns table (
        left json,
        right json
      )
      as $$
        with t as (
          ...
          where ii.station_id=_station_id
            ...
            and (i.timestamp at time zone s.timezone)::date between _min_date and _max_date
